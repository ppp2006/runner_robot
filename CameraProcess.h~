...
public:
	...
	//void distortionData(string sFilePath, Mat &intrinsics, Mat &distortion_coeff, bool isRead=false);
        void distortionData(const char* file, Mat &intrinsics, Mat &distortion_coeff, bool isRead=false);
        void distortionData(const char* file, CvMat* intrinsics, CvMat* distortion_coeff, bool isRead=false);
private:
